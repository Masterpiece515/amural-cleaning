...
const team = [
  {
    ...
    bio: "5–6 лет в сфере управления и организации бизнеса. Лично контролирует качество каждого заказа.",
  },
  {
    name: "Команда специалистов",
    role: "Клинеры",
    bio: "Обученные и проверенные сотрудники с опытом более 5 лет именно в профессиональной уборке.",
  },
];
...
const milestones = [
  { year: "2024", text: "Основание компании Amural Cleaning в Чите" },
  { year: "2025", text: "Первые клиенты и первые положительные отзывы" },
  { year: "2025", text: "Расширение списка услуг: уборка офисов и коммерческих помещений" },
  { year: "2026", text: "Продолжаем расти и улучшать качество сервиса" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed">
            Мы — молодая команда профессионалов из Читы, которая делает дома и офисы чище, уютнее и здоровее.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          <div className="bg-[#313130] rounded-3xl p-8 lg:p-10 flex flex-col gap-5">
            ...
            <div className="grid grid-cols-3 gap-4 mt-2">
              {[["250+", "уборок"], ["6+", "лет опыта"], ["20+", "отзывов"]].map(([v, l]) => (
