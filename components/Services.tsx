...
const services = [
  {
    ...
    photo: "https://images.unsplash.com/photo-1675937428940-6f0ddd4ce5c6?w=600&q=80",
    icon: (
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1663011218145-c1d0c3ba3542?w=600&q=80",
    icon: (
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth={2}>
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1527352774566-e4916e36c645?w=600&q=80",
    icon: (
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth={2}>
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1686178827149-6d55c72d81df?w=600&q=80",
    icon: (
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth={2}>
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1627905646269-7f034dcc5738?w=600&q=80",
    icon: (
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth={2}>
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=600&q=80",
    icon: (
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth={2}>
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1563453392212-326f5e854473?w=600&q=80",
    icon: (
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth={2}>
